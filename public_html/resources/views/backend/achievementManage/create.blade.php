        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="dash-header-card mb-4">
                <div class="dash-header-card-content">
                    ...
                    <div>
                        <h3 class="dash-header-card-title">Tambah Prestasi</h3>
                        <p class="dash-header-card-desc">Lengkapi form di bawah untuk mendaftarkan prestasi membanggakan baru dari siswa-siswi</p>
                    </div>
                </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-lg @error('medal') is-invalid @enderror" 
                                    ...
                                    <option value="gold" {{ old('medal') == 'gold' ? 'selected' : '' }}>🥇 Emas / Juara 1</option>
                                    <option value="silver" {{ old('medal') == 'silver' ? 'selected' : '' }}>🥈 Perak / Juara 2</option>
                                    <option value="bronze" {{ old('medal') == 'bronze' ? 'selected' : '' }}>🥉 Perunggu / Juara 3</option>
                                </select>
                                @error('medal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
