        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="dash-header-card mb-4">
                <div class="dash-header-card-content">
                    ...
                    <div>
                        <h3 class="dash-header-card-title">Tambah Fasilitas</h3>
                        <p class="dash-header-card-desc">Lengkapi form di bawah untuk mendaftarkan sarana atau prasarana sekolah baru</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('facilities.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-control-lg @error('category') is-invalid @enderror" 
                                ...
                                <option value="Akademik" {{ old('category') == 'Akademik' ? 'selected' : '' }}>Akademik (Ruang Kelas, Lab IPA, Perpustakaan)</option>
                                <option value="Teknologi" {{ old('category') == 'Teknologi' ? 'selected' : '' }}>Teknologi (Lab Komputer, Multimedia)</option>
                                <option value="Olahraga" {{ old('category') == 'Olahraga' ? 'selected' : '' }}>Olahraga (Lapangan, Gym)</option>
                                <option value="Ibadah" {{ old('category') == 'Ibadah' ? 'selected' : '' }}>Ibadah (Musholla, Masjid)</option>
                                <option value="Pendukung" {{ old('category') == 'Pendukung' ? 'selected' : '' }}>Pendukung (Kantin, Toilet, UKS)</option>
                            </select>
                            @error('category')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
