...
@section('content')
    <div class="article-container" style="margin-top: 70px;">
        ...
        <img src="{{ asset('storage/' . json_decode($ekstrakurikuler->photo_path)[0]) }}" class="article-image"
            alt="Article Image">
        ...
        @if (count(json_decode($ekstrakurikuler->photo_path)) > 1)
            <div class="row">
                @foreach (array_slice(json_decode($ekstrakurikuler->photo_path), 1) as $photo)
